...
class ApiController extends AbstractFOSRestController
{
     ...
     * @return float|View;
     */
    public function calculatePrice(ParamFetcher $paramFetcher, ValidatorInterface $validator): float|View
    {
     ...
     * @return View;
     */
    public function processPayment(ParamFetcher $paramFetcher, ValidatorInterface $validator): View
    {
        $constraint = new TaxNumberConstraint();
        ...
        try {
            ...
            switch ($paramFetcher->get('paymentProcessor')) {
                case 'paypal':
                    (new PaypalPaymentProcessor())->pay((int)($price * 100));
                    break;
